...
const steps = [
  ...
  { number: "02", icon: Search, title: "اكتشف ما يناسبك", description: "ابحث في الفٌرص واستخدم خيارات التصفية للوصول إلى الأنسب لك." },
...
export function HowItWorksSection() {
  return <section id="how-it-works" className="scroll-mt-24 overflow-hidden border-y border-neutral-200 bg-neutral-50 px-4 py-20 md:px-6 md:py-28 lg:px-8"><div className="mx-auto max-w-7xl">
    <ScrollReveal className="mx-auto max-w-2xl text-center"><h2 className="font-heading text-4xl font-bold text-neutral-900 md:text-5xl">من إنشاء الحساب إلى متابعة طلبك</h2><p className="mt-4 text-body-lg text-secondary">خطوات واضحة تساعدك على إنشاء ملفك، واكتشاف الفٌرص، ومتابعة طلباتك.</p></ScrollReveal>
