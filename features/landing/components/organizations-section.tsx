...
const benefits = ["نشر منظم لفٌرص العمل والتطوع والتدريب", "ملفات متقدمين واضحة في لوحة واحدة", "ترتيب إرشادي يساعد فريقك ولا يستبدل قراره"];
