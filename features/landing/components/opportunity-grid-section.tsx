...
const paths = [
  { title: "الوظائف", description: "فرص مهنية تفتح لك أبواب الخبرة والنمو.", href: "/register", image: "/images/landing/opportunity-work.webp", alt: "شاب سعودي يعمل على حاسوبه في مكتب حديث" },
