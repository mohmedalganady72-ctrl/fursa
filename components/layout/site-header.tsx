...
const NAV_LINKS = [
  { href: "/#about", label: "عن فٌرص" }, { href: "/#opportunities", label: "المسارات" },
...
export function SiteHeader() {
  ...
  return <header className="sticky top-0 z-40 border-b border-neutral-200 bg-surface">
    <div className="mx-auto flex h-20 max-w-7xl items-center gap-8 px-4 md:px-6 lg:px-8">
      ...
      <div className="ms-auto hidden shrink-0 items-center gap-2 md:flex"><ThemeToggle /><Button variant="ghost" asChild><Link href="/login">تسجيل الدخول</Link></Button><Button asChild><Link href="/register">انضم إلى فٌرص <ArrowLeft className="h-4 w-4 rtl-flip" /></Link></Button></div>
