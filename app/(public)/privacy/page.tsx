...
const sections = [
  ...
  ["كيف نستخدم البيانات", "نستخدم البيانات لإنشاء الحساب، مطابقة الباحث بالفرص، معالجة التقديمات، تمكين التواصل، إرسال التنبيهات، حماية المنصة وتحسين أدائها."],
  ["مشاركة البيانات", "تظهر بيانات التقديم للجهة صاحبة الفرصة وفق الحاجة المهنية. لا نبيع بياناتك الشخصية، ولا نشاركها خارج تشغيل الخدمة إلا بموافقتك أو عند وجود التزام نظامي."],
  ["الحفظ والحماية", "نحتفظ بالبيانات للمدة اللازمة لتقديم الخدمة والوفاء بالمتطلبات النظامية، ونستخدم ضوابط وصول وتقنيات حماية مناسبة لتقليل مخاطر الوصول غير المصرح."],
