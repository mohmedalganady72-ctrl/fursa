 ...
 * يحسب درجة توافق الباحث مع كل الفٌرص المفتوحة من نوع "عمل" (البحث الذكي موثَّق
 * في وثيقة المتطلبات لفٌرص العمل تحديدًا)، ويُعيدها مرتَّبة تنازليًا حسب الدرجة.
 *
 * ملاحظة أداء: هذا التطبيق الأولي يحسب الدرجة لكل الفٌرص المفتوحة في الذاكرة،
 * وهو مقبول لحجم بيانات مرحلة الإطلاق. مع نمو عدد الفٌرص، يُستبدل هذا بحساب
