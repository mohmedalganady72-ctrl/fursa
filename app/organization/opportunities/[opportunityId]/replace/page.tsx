  ...
  return (
    <div>
      ...
      <p className="mt-1 text-body text-secondary">
        لا يمكن تعديل الفرص المنشورة مباشرة. أدخل البيانات الجديدة أدناه؛ وعند
        الإرسال ستُغلق الفرصة الحالية تلقائيًا وتُنشر النسخة الجديدة.
      </p>

      <Card className="mt-4 flex items-start gap-3 border-warning-500/30 bg-warning-50 p-4">
        <AlertTriangle className="mt-0.5 h-5 w-5 shrink-0 text-amber-600" />
        <p className="text-body-sm text-amber-800">
          سيتوقف استقبال طلبات جديدة للفرصة الحالية فور إرسال هذا النموذج،
          وستبقى الطلبات الحالية محفوظة في سجل الفرص المغلقة.
        </p>
      </Card>
